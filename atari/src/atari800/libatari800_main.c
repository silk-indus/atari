...
/* Profiling values are written by emulation core and printed by main.cpp/core 1.
   Units are raw CPU cycles; main.cpp divides by 240 for us at 240 MHz. */
volatile unsigned int libatari800_prof_core_ticks = 0;
volatile unsigned int libatari800_prof_display_ticks = 0;
volatile unsigned int libatari800_prof_total_ticks = 0;
volatile unsigned int libatari800_prof_devices_ticks = 0;
volatile unsigned int libatari800_prof_input_ticks = 0;
volatile unsigned int libatari800_prof_gtia_ticks = 0;
volatile unsigned int libatari800_prof_antic_ticks = 0;
volatile unsigned int libatari800_prof_post_ticks = 0;
volatile unsigned int libatari800_prof_pokey_ticks = 0;
volatile unsigned int libatari800_prof_sound_ticks = 0;
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_devices_ticks = t1 - t0;
	t0 = t1;
#endif
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_input_ticks = t1 - t0;
	t0 = t1;
#endif
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_gtia_ticks = t1 - t0;
	t0 = t1;
#endif

	static int esp_frameskip = 0;

ANTIC_Frame(esp_frameskip == 0);
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_antic_ticks = t1 - t0;
	t0 = t1;
#endif
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_post_ticks = t1 - t0;
	t0 = t1;
#endif
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_pokey_ticks = t1 - t0;
	t0 = t1;
#endif
...
#ifdef ESP_PLATFORM
	t1 = XTHAL_GET_CCOUNT();
	libatari800_prof_sound_ticks = t1 - t0;
#endif
#else
#ifdef ESP_PLATFORM
	libatari800_prof_sound_ticks = 0;
#endif
#endif
...
#ifdef ESP_PLATFORM
	t2 = XTHAL_GET_CCOUNT();
	libatari800_prof_core_ticks = t1 - t0;
	libatari800_prof_display_ticks = t2 - t1;
	libatari800_prof_total_ticks = t2 - t0;
#else
	t2 = t1;
#endif
